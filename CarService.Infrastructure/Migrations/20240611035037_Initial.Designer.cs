...
namespace CarService.Infrastructure.Migrations
{
    ...
    [Migration("20240611035037_Initial")]
            ...
            modelBuilder.Entity("CarService.Core.Users.UserAuth", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("aa9e783d-74cf-4fec-bb93-9741dd2fb04b"),
                            CreateDate = new DateTime(2024, 6, 11, 3, 50, 36, 457, DateTimeKind.Utc).AddTicks(792),
                            Email = "admin@localhost",
                            PasswordHash = "$2a$11$dFMuHptWChXQqO90V3t1oOU5juvKeBO1pqx259k8reEJe4GquZvkC",
                            RoleId = 1,
                            UsesInfoId = new Guid("2269f768-d05b-4a6b-aa8c-e4c67d3e53f2")
                        });
                });
            ...
            modelBuilder.Entity("CarService.Core.Users.UserInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2269f768-d05b-4a6b-aa8c-e4c67d3e53f2"),
                            Address = "Админ",
                            Email = "admin@localhost",
                            FirstName = "Админ",
                            LastName = "Админ",
